...
static const unsigned int gappx     = 6;        /* gap between windows in pixels */
static const int alwayscenter       = 1;        /* center new floating windows */
...
/* volume commands (PulseAudio / pipewire-pulse) */
...
static const Key keys[] = {
	...
	/* --- gaps: Super+G toggle, Super+= increase, Super+- decrease, Super+Shift+G reset --- */
